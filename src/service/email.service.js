...
function sendEmail(email, bookTitle, dueDate) {
    const mailOptions = {
        ...
        html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; color: #333; font-size: 16px;"> 
            <h2>Lembrete da Biblioteca Comunitária</h2>
            <p>Olá,</p> 
            <p>Este é um lembrete para a devolução do livro "${bookTitle}".</p> <p>Data de devolução: ${dueDate}</p> 
